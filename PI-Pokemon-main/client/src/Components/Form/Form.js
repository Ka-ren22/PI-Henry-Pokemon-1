...
export default function PokemonCreate(){
    ...
    function handleSection(e){
        ...
        Object.keys(errors).length === 1 && errors.types.length ?
            ...
            :
            alert("You must complete the form correctly!", "", "error");
    }
    ...
    return(
        <div className={style.pagina}>
            ...
            <Link to='/home' className={style.back} style={{textDecoration: 'none'}}>
                ...
                <form onSubmit={ (e) => handleSubmit(e) }>
                    ...
                    <div className={style.formdiv}>
                        ...
                        <input 
                            ...
                            name="hp"
                            onChange={ (e) => handleChange(e) }
                            style={input.hp.length ? errors.hp ? {borderColor: '#e74c3c' } : 
                            {borderColor: '#2ecc71'} : {}}
                        />
                        {
                            errors.hp ? (
                    ...
                    <div className={style.formdiv}>
                        ...
                        <input 
                            ...
                            name="attack"
                            onChange={ (e) => handleChange(e) }
                            style={input.attack.length ? errors.attack ? {borderColor: '#e74c3c' } : 
                            {borderColor: '#2ecc71'} : {}}
                        />
                        {
                            errors.attack ? (
                    ...
                    <div className={style.formdiv}>
                        ...
                        <input 
                            ...
                            name="defense"
                            onChange={ (e) => handleChange(e) }
                            style={input.defense.length ? errors.defense ? {borderColor: '#e74c3c' } : 
                            {borderColor: '#2ecc71'} : {}}
                        />
                        {
                             errors.defense ? (
                    ...
                    <div className={style.formdiv}>
                        ...
                        <input 
                            ...
                            name="speed"
                            onChange={ (e) => handleChange(e) }
                            style={input.speed.length ? errors.speed ? {borderColor: '#e74c3c' } :
                             {borderColor: '#2ecc71'} : {}}
                        />
                        {
                             errors.speed ? (
                    ...
                    <div className={style.formdiv}>
                        ...
                        <input 
                            ...
                            name="weight"
                            onChange={ (e) => handleChange(e) }
                            style={input.weight.length ? errors.weight ? {borderColor: '#e74c3c' } : 
                            {borderColor: '#2ecc71'} : {}}
                        />
                        {
                             errors.weight ? (
                    ...
                    <div className={style.formdiv}>
                        ...
                        <input 
                            ...
                            name="height"
                            onChange={ (e) => handleChange(e) }
                            style={input.height.length ? errors.height ? {borderColor: '#e74c3c' } :
                             {borderColor: '#2ecc71'} : {}}
                        />
                        {
                            errors.height ? (
                    ...
                    <section className={section === 2 ? style.show : style.hide}>
                        <div style={{position:'relative'}}> 
                            <span className={style.choosetypes} style={{display:'flex', 
                            justifyContent:'flex-start', fontFamily:'Open Sans'}}>Choose up to 2 Pokemon types
                            </span>
                                ...
                                types.map( type => (
                                    <label for={type.name}>
                                        <div className={style.bytype} > 
                                            ...
                                            />
                                            <div className={style.circle} style={{display:'flex', 
                        ...
                        <div style={{display:'flex', flexFlow:'row nowrap'}}> 
                            ...
                            onClick={(e) => {handleSection(e)}}>Previous</button>
